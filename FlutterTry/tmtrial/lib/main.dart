    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color.fromARGB(255, 6, 94, 9),
          primary: Color.fromARGB(255, 6, 94, 9),
          onPrimary: Color.fromARGB(255, 233, 204, 78),
          primaryContainer: Color.fromARGB(255, 233, 204, 78),
          onBackground: Color.fromARGB(255, 19, 165, 24),
          outline: Color.fromARGB(255, 19, 165, 24),
        ),
        textTheme: TextTheme(
      ...
      home: const MyHomePage(title: 'Tilal Al-Masaken Home Page'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        //title: RichText(text: TextSpan(text: "hi")),
        title: Text('Hi'),
      ),
      body: Center(
